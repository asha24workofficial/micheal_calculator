    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-xl p-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div
              className="absolute left-0 top-0 bottom-0 w-4 rounded-l-[17px] bg-customBlue"
            />
          ...
          >
            <div
              className="absolute left-0 top-0 bottom-0 w-4 rounded-l-[17px] bg-customDarkBlue"
            />
